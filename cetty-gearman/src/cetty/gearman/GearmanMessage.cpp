...
//
//GearmanMessagePtr GearmanMessage::createMessages(int type,const std::vector<const std::string>& params,bool havaData,const ChannelBufferPtr& data)
//{
...
//		{
//			request->addParameter()->assign(*iter);
//		}
//	}
//	if(havaData)
//	{
