#if !defined(CETTY_SHIRO_SESSION_SESSIONLISTENER_H)
#define CETTY_SHIRO_SESSION_SESSIONLISTENER_H
/*
...
class SessionListener {
     ...
     */
    void onStart(const Session *session);
     ...
     */
    void onStop(const Session *session);
     ...
     */
    void onExpiration(const Session *session);
};
}
}
}

#endif // #if !defined(CETTY_SHIRO_SESSION_SESSIONLISTENER_H)
