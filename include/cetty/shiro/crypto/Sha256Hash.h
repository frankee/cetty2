#if !defined(CETTY_SHIRO_CRYPTO_SHA256HASH_H)
#define CETTY_SHIRO_CRYPTO_SHA256HASH_H
/*
 ...
 * @since 1.1
 */
class Sha256Hash : public CodecSupport{
private:
    /**
     * The hashed data
     */
...
public:
     ...
     *         this Hash's byte array, {@code false} otherwise.
     */
    bool equals(const Sha256Hash &o) {
        return getBytes() == o.getBytes();
    }
...
private:
    static void printMainUsage(const Sha256Hash &clazz, const std::string &type);
    static bool isReserved(const std::string &args);
    static int doMain(const Sha256Hash &clazz, std::string *args);
public:
