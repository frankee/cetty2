#if !defined(CETTY_CHANNEL_CHANNELMESSAGEHANDLERADAPTER_H)
#define CETTY_CHANNEL_CHANNELMESSAGEHANDLERADAPTER_H
...
class ChannelMessageHandlerAdapter
...
#endif //#if !defined(CETTY_CHANNEL_CHANNELMESSAGEHANDLERADAPTER_H)
