#if !defined(CETTY_CHANNEL_CHANNELINBOUNDMESSAGEHANDLERADAPTER_H)
#define CETTY_CHANNEL_CHANNELINBOUNDMESSAGEHANDLERADAPTER_H
...
#endif //#if !defined(CETTY_CHANNEL_CHANNELINBOUNDMESSAGEHANDLERADAPTER_H)
