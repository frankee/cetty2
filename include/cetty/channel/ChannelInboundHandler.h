#if !defined(CETTY_CHANNEL_CHANNELINBOUNDHANDLER_H)
#define CETTY_CHANNEL_CHANNELINBOUNDHANDLER_H
...
public:
     ...
     *
     */
    virtual void channelActive(ChannelHandlerContext& ctx) = 0;
    
    /**
     *
     */
    virtual void channelInactive(ChannelHandlerContext& ctx) = 0;
...
#endif //#if !defined(CETTY_CHANNEL_CHANNELINBOUNDHANDLER_H)
