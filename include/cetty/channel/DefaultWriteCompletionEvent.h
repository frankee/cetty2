...
public:
     ...
     */
    DefaultWriteCompletionEvent(const ChannelPtr& channel, int writtenAmount);
...
private:
    DefaultWriteCompletionEvent(const DefaultWriteCompletionEvent&);
    DefaultWriteCompletionEvent& operator=(const DefaultWriteCompletionEvent&);
