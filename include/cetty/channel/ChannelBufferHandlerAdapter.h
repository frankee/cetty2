#if !defined(CETTY_CHANNEL_CHANNELBUFFERHANDLERADAPTER_H)
#define CETTY_CHANNEL_CHANNELBUFFERHANDLERADAPTER_H
...
class ChannelBufferHandlerAdapter : public ChannelBufferHandler {
public:
    virtual ~ChannelBufferHandlerAdapter() {}
...
#endif //#if !defined(CETTY_CHANNEL_CHANNELBUFFERHANDLERADAPTER_H)
