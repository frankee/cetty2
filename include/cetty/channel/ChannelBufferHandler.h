#if !defined(CETTY_CHANNEL_CHANNELBUFFERHANDLER_H)
#define CETTY_CHANNEL_CHANNELBUFFERHANDLER_H
...
class ChannelBufferHandler
    : public ChannelInboundBufferHandler,
      public ChannelOutboundBufferHandler {
public:
    virtual ~ChannelBufferHandler();
...
#endif //#if !defined(CETTY_CHANNEL_CHANNELBUFFERHANDLER_H)
