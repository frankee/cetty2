#if !defined(CETTY_PROTOBUF_SERVICE_HTTP_MAP_SERVICEREQUESTMAPPERCONFIG_H)
#define CETTY_PROTOBUF_SERVICE_HTTP_MAP_SERVICEREQUESTMAPPERCONFIG_H
...
#endif //#if !defined(CETTY_PROTOBUF_SERVICE_HTTP_MAP_SERVICEREQUESTMAPPERCONFIG_H)
