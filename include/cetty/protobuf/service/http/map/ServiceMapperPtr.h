#if !defined(CETTY_PROTOBUF_SERVICE_HTTP_MAP_SERVICEMAPPERPTR_H)
#define CETTY_PROTOBUF_SERVICE_HTTP_MAP_SERVICEMAPPERPTR_H
...
#endif //#if !defined(CETTY_PROTOBUF_SERVICE_HTTP_MAP_SERVICEMAPPERPTR_H)
