#if !defined(CETTY_HANDLER_EXECUTION_ORDEREDSERVICEPOOLEXECUTOR_H)
#define CETTY_HANDLER_EXECUTION_ORDEREDSERVICEPOOLEXECUTOR_H
 ...
 * @apiviz.landmark
 */
class OrderedServicePoolExecutor : public ServicePoolExecutor {
    ...
    Executor getChildExecutor(ChannelEvent e) {
...
#endif //#if !defined(CETTY_HANDLER_EXECUTION_ORDEREDSERVICEPOOLEXECUTOR_H)
