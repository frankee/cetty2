#if !defined(CETTY_CRAFT_HTTPREQUEST2PROTOBUFMESSAGE_H)
#define CETTY_CRAFT_HTTPREQUEST2PROTOBUFMESSAGE_H
...
private:
    bool parseMessage(const HttpRequestTemplate& tmpl,
                      const HttpRequestPtr& request,
                      Message* message);

    bool parseField(const HttpRequestTemplate& tmpl,
                    const HttpRequestPtr& request,
...
#endif //#if !defined(CETTY_CRAFT_HTTPREQUEST2PROTOBUFMESSAGE_H)
