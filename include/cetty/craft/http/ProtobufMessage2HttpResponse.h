#if !defined(CETTY_CRAFT_HTTP_PROTOBUFMESSAGE2HTTPRESPONSE_H)
#define CETTY_CRAFT_HTTP_PROTOBUFMESSAGE2HTTPRESPONSE_H
...
#endif //#if !defined(CETTY_CRAFT_HTTP_PROTOBUFMESSAGE2HTTPRESPONSE_H)
