#if !defined(CETTY_CRAFT_HTTP_SERVICERESPONSEMAPPERCONFIG_H)
#define CETTY_CRAFT_HTTP_SERVICERESPONSEMAPPERCONFIG_H
...
#endif //#if !defined(CETTY_CRAFT_HTTP_SERVICERESPONSEMAPPERCONFIG_H)
