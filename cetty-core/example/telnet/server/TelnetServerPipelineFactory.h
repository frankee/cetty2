#if !defined(TELNET_TELNETSERVERPIPELINEFACTORY_H)
#define TELNET_TELNETSERVERPIPELINEFACTORY_H
 ...
 *
 */
class TelnetServerPipelineFactory : public cetty::channel::ChannelPipelineFactory {
public:
    TelnetServerPipelineFactory() {}
    virtual ~TelnetServerPipelineFactory() {}
    ...
    virtual ChannelPipeline* getPipeline() {
        ...
        pipeline->addLast("handler", ChannelHandlerPtr(new TelnetServerHandler()));
...
#endif //#if !defined(TELNET_TELNETSERVERPIPELINEFACTORY_H)
