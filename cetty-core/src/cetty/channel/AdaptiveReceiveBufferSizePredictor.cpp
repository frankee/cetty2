...
const int AdaptiveReceiveBufferSizePredictor::DEFAULT_MINIMUM = 256;
const int AdaptiveReceiveBufferSizePredictor::DEFAULT_INITIAL = 1024 * 4;
const int AdaptiveReceiveBufferSizePredictor::DEFAULT_MAXIMUM = 1024 * 128;
...
int AdaptiveReceiveBufferSizePredictor::nextReceiveBufferSize() const {
